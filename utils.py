...
def confmatrix(logits, label, filename):
    ...
    matplotlib.rcParams.update({'font.family': 'Times New Roman', 'font.size': 14})
    ...
    if clss <= 100:
        plt.yticks([0, 19, 39, 59, 79, 99], [0, 20, 40, 60, 80, 100], fontsize=12)
        plt.xticks([0, 19, 39, 59, 79, 99], [0, 20, 40, 60, 80, 100], fontsize=12)
    elif clss <= 200:
        plt.yticks([0, 39, 79, 119, 159, 199], [0, 40, 80, 120, 160, 200], fontsize=12)
        plt.xticks([0, 39, 79, 119, 159, 199], [0, 40, 80, 120, 160, 200], fontsize=12)
    else:
        plt.yticks([0, 199, 399, 599, 799, 999], [0, 200, 400, 600, 800, 1000], fontsize=12)
        plt.xticks([0, 199, 399, 599, 799, 999], [0, 200, 400, 600, 800, 1000], fontsize=12)
    ...
    plt.ylabel('True Label', fontsize=16)
    plt.tight_layout()
    plt.savefig(filename + '_cbar.pdf', dpi=300, bbox_inches='tight')
    plt.close()
